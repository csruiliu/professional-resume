...
\name{Your}{Name}
\address{your current residential/working address}
\mobile{your mobile number}

\email{your@email.address}
%\email{rui.liu@gmx.com}
...
\position{Your current position{\enskip\cdotp\enskip}Your expertise/fields} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{}{Your Name~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
